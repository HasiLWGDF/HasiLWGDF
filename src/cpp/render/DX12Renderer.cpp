...
{
	const std::unique_ptr<Logger> pLogger = std::make_unique<Logger>(Logger("DX12Renderer"));
	class DX12Renderer final : public Graphics::Renderer
	{
	private:
	...
	std::unique_ptr<Graphics::Renderer> createDX12Renderer()
	{
