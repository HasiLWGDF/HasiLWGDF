...
{
    const std::unique_ptr<Logger> pLogger = std::make_unique<Logger>(Logger("PhysicsEngine2D"));
    class PhysicsEngine2D final : public PhysicsEngine
    {
    private:
    ...
    {
        return std::make_unique<PhysicsEngine2D>(PhysicsEngine2D{});
    }
}
