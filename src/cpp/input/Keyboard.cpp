...
{
    std::unique_ptr<Logger> pLogger = std::make_unique<Logger>(Logger("Input.Keyboard"));
    ...
    float _Keyboard_::getKeyAxis(Keyboard::KeyCode positive, Keyboard::KeyCode negative)
    {
    ...
    extern "C" HASILWGDF_EXPORT float Keyboard::getKeyAxis(KeyCode positive, KeyCode negative)
    {
