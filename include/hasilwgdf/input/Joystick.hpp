...
extern "C"
{
    namespace Hasibix::HasiLWGDF::Core::Input
    {
        ...
        public:
            ...
            HASILWGDF_EXPORT static bool getJoystickPressed(int joystick, JoystickBtn btn);
            HASILWGDF_EXPORT static bool getJoystickReleased(int joystick, JoystickBtn btn);
            HASILWGDF_EXPORT static float getJoystickAxis(int joystick, JoystickAxis axis);
        };
    }
}
