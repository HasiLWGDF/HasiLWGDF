...
extern "C"
{
    ...
    namespace Hasibix::HasiLWGDF::Core::Game
    {
        ...
        public:
            HASILWGDF_EXPORT static bool getKeyDown(InputManager::KeyCode key);
            HASILWGDF_EXPORT static bool getKeyPressed(InputManager::KeyCode key);
            HASILWGDF_EXPORT static bool getKeyReleased(InputManager::KeyCode key);

            HASILWGDF_EXPORT static bool getMouseDown(InputManager::MouseBtn btn);
            HASILWGDF_EXPORT static bool getMousePressed(InputManager::MouseBtn btn);
            HASILWGDF_EXPORT static bool getMouseReleased(InputManager::MouseBtn btn);
            HASILWGDF_EXPORT static Math::Vector2 getMousePos();

            HASILWGDF_EXPORT static bool getJoystickDown(InputManager::JoystickBtn btn);
            HASILWGDF_EXPORT static bool getJoystickPressed(InputManager::JoystickBtn btn);
            HASILWGDF_EXPORT static bool getJoystickReleased(InputManager::JoystickBtn btn);
            HASILWGDF_EXPORT static bool getJoystickAxis(InputManager::JoystickAxis axis);
        };
    }
#ifdef __cplusplus
}
