...
namespace Hasibix::HasiUtils
{
        ...
        public:
                ...
                void log(Level logLevel, std::string message...)
                {
                        ...
                        {
                        case Level::INFO:
                                prefix = LogColor::RESET + "[" + LogColor::WHITE + getTime() + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::GREEN + "Info" + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::CYAN + originName + LogColor::RESET + "]: ";
                                break;
                        case Level::DEBUG:
                                prefix = LogColor::RESET + "[" + LogColor::WHITE + getTime() + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::PURPLE + "Debug" + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::CYAN + originName + LogColor::RESET + "]: ";
                                break;
                        case Level::WARN:
                                prefix = LogColor::RESET + "[" + LogColor::WHITE + getTime() + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::YELLOW + "Warning" + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::CYAN + originName + LogColor::RESET + "]: ";
                                break;
                        case Level::ERR:
                                prefix = LogColor::RESET + "[" + LogColor::WHITE + getTime() + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::RED + "Error" + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::CYAN + originName + LogColor::RESET + "]: ";
                                break;
                        case Level::FATAL:
                                prefix = LogColor::RESET + "[" + LogColor::WHITE + getTime() + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::BLUE + "Fatal" + LogColor::RESET + "]" + LogColor::RESET + " [" + LogColor::CYAN + originName + LogColor::RESET + "]: ";
                                break;
                        default:
