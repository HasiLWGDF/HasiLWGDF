...
namespace Hasibix::HasiUtils::JSON
{
	...
	public:
		...
		JSONString(const std::string &v) : JSONValue(JSONType::String), value(v)
		{
		}
	...
	public:
		...
		JSONNumber(double v) : JSONValue(JSONType::Number), value(v)
		{
		}
	...
	public:
		...
		JSONBoolean(bool v) : JSONValue(JSONType::Boolean), value(v)
		{
		}
	...
	JSONNumber *JSONParser::parseNumber()
	{
		...
		while (pos < json.size() && (std::isdigit(currentChar()) || currentChar() == '.' || currentChar() == 'e' || currentChar() == 'E' || currentChar() == '+' || currentChar() == '-'))
		{
			pos++;
		}
